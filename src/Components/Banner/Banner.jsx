...
const Banner = () => {
    return (
        <div className="md:justify-center flex flex-col lg:flex-row gap-10 container justify-center mx-auto items-center">
            <div className='mb-10 md:text-center lg:text-start lg:mr-5'>
...
Watch Demo</p>
<div className="flex gap-4 mt-5 md:justify-center lg:justify-start">
...
<button className=' rounded-4xl p-4 bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-transparent bg-clip-text border-2 border-purple-600 flex items-center gap-2 '><img src="/src/assets/Play.png" alt="" /> Watch demo</button>
            ...
            <div className='md:justify-center lg:justify-end'>
                <img className='w-full max-w-md md:max-w-lg lg:max-w-xl shadow-2xl' src="/src/assets/banner.png" alt="" />
            </div>
        </div>
    );
};
