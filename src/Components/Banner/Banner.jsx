...
const Banner = () => {
    return (
        <div className="md:justify-center lg:flex md:flex-row lg:gap-5 container justify-center mx-auto items-center">
...
<button className=' rounded-4xl p-4 bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-transparent bg-clip-text border-2 border-purple-600 flex items-center gap-2 '><img src="/src/assets/Play.png" alt="" /> Watch demo</button>
            ...
            <div className='md:justify-center'>
                <img className='shadow-2xl lg::w-125 lg::h-147.5' src="/src/assets/banner.png" alt="" />
            </div>
        </div>
    );
};
